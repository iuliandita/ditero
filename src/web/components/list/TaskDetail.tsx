...
export function TaskDetail({
	...
	// Centered modal on desktop, bottom sheet on phones. The rail this
	// replaced put a 13-section form against the screen edge; the modal keeps
	// every section and scrolls rather than splitting into primary/advanced,
